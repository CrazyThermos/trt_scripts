...
if __name__ == "__main__":
        ...
        build_engine(
                #  dynamic_shapes={'b' : [(2,3,640,640),(16,3,640,640),(32,3,640,640)]},
                 onnx_file = './weights/rgbt_ca_rtdetrv2_589_m3fd_one_input.onnx', 
                 engine_file = 'rgbt_ca_rtdetrv2_589_m3fd_one_input_SYMM_LINEAR_PERCHANNEL.engine', 
                 workspace_size = 4294967296<<4, 
                 config = config,  
                 imgpath = '/workspace/datasets//val',
                 img_shape = (2, 3, 640, 640),
